      ...
      subnets = merge(
        ...
        },
        {
          "OKE-VCN-3-SERVICES-SUBNET" = {
            ...
            ipv6cidr_blocks           = []
            prohibit_internet_ingress = (local.hub_with_vcn == true && var.oke_vcn3_attach_to_drg == true) ? true : false
      ...
      route_tables = merge({
        "OKE-VCN-3-API-SUBNET-ROUTE-TABLE" = {
          ...
          route_rules = merge(
            ...
            (local.chosen_hub_option != 3 && local.chosen_hub_option != 4) && upper(var.oke_vcn3_cni_type) == "NATIVE" ? {
              "NATGW-RULE" = {
