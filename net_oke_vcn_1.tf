  ...
  oke_vcn_1 = local.add_oke_vcn1 == true ? {
    "OKE-VCN-1" = {
      ...
      subnets = merge(
        ...
        },
        {
          "OKE-VCN-1-WORKERS-AD1-SUBNET" = {
            ...
            security_list_keys        = ["OKE-VCN-1-WORKERS-AD1-SUBNET-SL"]
          }
        },
        {
      ...
      security_lists = merge(
        ...
        {
          "OKE-VCN-1-WORKERS-AD1-SUBNET-SL" = {
            display_name = "${var.oke_vcn1_workers_ad1_subnet_name}-security-list"
            egress_rules = []
            ingress_rules = [
              {
                description = "Allows inbound ICMP traffic for path discovery"
        ...
        {
          "OKE-VCN-1-WORKERS-AD2-SUBNET-SL" = {
            display_name = "${var.oke_vcn1_workers_ad2_subnet_name}-security-list"
            egress_rules = []
            ingress_rules = [
              {
                description = "Allows inbound ICMP traffic for path discovery"
        ...
        {
          "OKE-VCN-1-WORKERS-AD3-SUBNET-SL" = {
            display_name = "${var.oke_vcn1_workers_ad3_subnet_name}-security-list"
            egress_rules = []
            ingress_rules = [
              {
                description = "Allows inbound ICMP traffic for path discovery"
      ...
      network_security_groups = merge(
        {
          "OKE-VCN-1-API-NSG" = {
            ...
            egress_rules = merge(
              ...
              {
                "EGRESS-TO-KUBELET-AD2-API-RULE" = {
                  description  = "Allow TCP egress from OKE control plane to Kubelet on worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-WORKERS-AD2-NSG"
                  dst_type     = "NETWORK_SECURITY_GROUP"
                  dst_port_min = 10250
                  dst_port_max = 10250
                }
              ...
              {
                "EGRESS-TO-KUBELET-AD3-API-RULE" = {
                  description  = "Allow TCP egress from OKE control plane to Kubelet on worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-WORKERS-AD3-NSG"
                  dst_type     = "NETWORK_SECURITY_GROUP"
                  dst_port_min = 10250
                  dst_port_max = 10250
                }
              ...
              {
                "EGRESS-TO-WORKERS-AD1-API-RULE" = {
              ...
              {
                "EGRESS-TO-WORKERS-AD2-API-RULE" = {
                  description  = "Allow TCP egress from OKE control plane to worker node"
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              {
                "EGRESS-TO-WORKERS-AD3-API-RULE" = {
                  description  = "Allow TCP egress from OKE control plane to worker node"
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-WORKERS-AD3-NSG"
              ...
              {
                "EGRESS-TO-WORKERS-AD1-ICMP-API-RULE" = {
              ...
              {
                "EGRESS-TO-WORKERS-AD2-ICMP-API-RULE" = {
                  description = "Allows outbound ICMP to worker nodes path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  dst         = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              {
                "EGRESS-TO-WORKERS-AD3-ICMP-API-RULE" = {
                  description = "Allows outbound ICMP to worker nodes path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  dst         = "OKE-VCN-1-WORKERS-AD3-NSG"
            ...
            ingress_rules = merge({
              ...
              {
                "INGRESS-FROM-WORKERS-AD2-6443-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
              ...
              {
                "INGRESS-FROM-WORKERS-AD3-6443-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
              ...
              {
                "INGRESS-FROM-WORKERS-AD1-10250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD1-NSG"
              ...
              {
                "INGRESS-FROM-WORKERS-AD2-10250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              {
                "INGRESS-FROM-WORKERS-AD3-10250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD3-NSG"
              ...
              {
                "INGRESS-FROM-WORKERS-AD1-12250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD1-NSG"
              ...
              {
                "INGRESS-FROM-WORKERS-AD2-12250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              {
                "INGRESS-FROM-WORKERS-AD3-12250-API-RULE" = {
                  description  = "Allows inbound TCP from worker nodes."
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-WORKERS-AD3-NSG"
              ...
              upper(var.oke_vcn1_cni_type) == "FLANNEL" ? {
                ...
                "INGRESS-FROM-WORKERS-AD1-ICMP-API-RULE" = {
                ...
                "INGRESS-FROM-WORKERS-AD2-ICMP-API-RULE" = {
                  description = "Allow ICMP ingress for path discovery from worker nodes."
                  stateless   = false
                  protocol    = "ICMP"
                  src         = "OKE-VCN-1-WORKERS-AD2-NSG"
                ...
                "INGRESS-FROM-WORKERS-AD3-ICMP-API-RULE" = {
                  description = "Allow ICMP ingress for path discovery from worker nodes."
                  stateless   = false
                  protocol    = "ICMP"
                  src         = "OKE-VCN-1-WORKERS-AD3-NSG"
          ...
          "OKE-VCN-1-WORKERS-AD1-NSG" = {
            ...
            egress_rules = merge(
              {
                "EGRESS-TO-WORKERS-AD1-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-WORKERS-AD2-WORKERS-AD1-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD2-NSG"
                ...
                "EGRESS-TO-WORKERS-AD3-WORKERS-AD1-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD3-NSG"
                ...
                "EGRESS-TO-SERVICES-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-API-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-CONTROL-PLANE-10250-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-CONTROL-PLANE-12250-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-ANYWHERE-ICMP-WORKERS-AD1-RULE" = {
                ...
                "EGRESS-TO-ANYWHERE-TCP-WORKERS-AD1-RULE" = {
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" ? {
                "EGRESS-TO-PODS-WORKERS-AD1-RULE" = {
            ...
            ingress_rules = merge({
              ...
              upper(var.oke_vcn1_cni_type) == "FLANNEL" ? {
                ...
                "INGRESS-FROM-ANYWHERE-ICMP-WORKERS-AD1-RULE" = {
                ...
                "INGRESS-FROM-BASTION-WORKERS-AD1-RULE" = {
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" && var.add_oke_vcn1_mgmt_subnet ? {
                "INGRESS-FROM-OPERATOR-WORKERS-AD1-RULE" = {
          ...
          "OKE-VCN-1-WORKERS-AD2-NSG" = {
            display_name = "workers-ad2-nsg"
            egress_rules = merge(
              {
                "EGRESS-TO-WORKERS-AD1-WORKERS-AD2-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD1-NSG"
                ...
                "EGRESS-TO-WORKERS-AD2-WORKERS-AD2-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD2-NSG"
                ...
                "EGRESS-TO-WORKERS-AD3-WORKERS-AD2-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD3-NSG"
                ...
                "EGRESS-TO-SERVICES-WORKERS-AD2-RULE" = {
                  description = "Allows outbound TCP egress to OCI Services."
                  stateless   = false
                  protocol    = "TCP"
                  dst         = "all-services"
                ...
                "EGRESS-TO-API-WORKERS-AD2-RULE" = {
                  description  = "Allows outbound TCP to OKE API endpoint."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-CONTROL-PLANE-10250-WORKERS-AD2-RULE" = {
                  description  = "Allows outbound TCP to OKE control plane health check."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-CONTROL-PLANE-12250-WORKERS-AD2-RULE" = {
                  description  = "Allows outbound TCP egress to OKE control plane."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-ANYWHERE-ICMP-WORKERS-AD2-RULE" = {
                  description = "Allows outbound ICMP for path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  dst         = "0.0.0.0/0"
                ...
                "EGRESS-TO-ANYWHERE-TCP-WORKERS-AD2-RULE" = {
                  description = "(optional) Allows worker nodes to communicate with the Internet."
                  stateless   = false
                  protocol    = "TCP"
                  dst         = "0.0.0.0/0"
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" ? {
                "EGRESS-TO-PODS-WORKERS-AD2-RULE" = {
                  description = "Allow worker nodes to access pods."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-PODS-NSG"
            ...
            ingress_rules = merge({
              ...
              upper(var.oke_vcn1_cni_type) == "FLANNEL" ? {
                ...
                "INGRESS-FROM-ANYWHERE-ICMP-WORKERS-AD2-RULE" = {
                  description = "Allow ICMP ingress to workers for path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  src         = "0.0.0.0/0"
                ...
                "INGRESS-FROM-BASTION-WORKERS-AD2-RULE" = {
                  description  = "Bastion service ssh access to workers"
                  stateless    = false
                  protocol     = "TCP"
                  src          = coalesce(var.oke_vcn1_mgmt_subnet_cidr, cidrsubnet(var.oke_vcn1_cidrs[0], 12, 48))
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" && var.add_oke_vcn1_mgmt_subnet ? {
                "INGRESS-FROM-OPERATOR-WORKERS-AD2-RULE" = {
                  description  = "Operator ssh access to workers"
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-MGMT-NSG"
          ...
          "OKE-VCN-1-WORKERS-AD3-NSG" = {
            display_name = "workers-ad3-nsg"
            egress_rules = merge(
              {
                "EGRESS-TO-WORKERS-AD1-WORKERS-AD3-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD1-NSG"
                ...
                "EGRESS-TO-WORKERS-AD2-WORKERS-AD3-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD2-NSG"
                ...
                "EGRESS-TO-WORKERS-AD3-WORKERS-AD3-RULE" = {
                  description = "Allows outbound access to worker nodes."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-WORKERS-AD3-NSG"
                ...
                "EGRESS-TO-SERVICES-WORKERS-AD3-RULE" = {
                  description = "Allows outbound TCP egress to OCI Services."
                  stateless   = false
                  protocol    = "TCP"
                  dst         = "all-services"
                ...
                "EGRESS-TO-API-WORKERS-AD3-RULE" = {
                  description  = "Allows outbound TCP to OKE API endpoint."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-CONTROL-PLANE-10250-WORKERS-AD3-RULE" = {
                  description  = "Allows outbound TCP to OKE control plane health check."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-CONTROL-PLANE-12250-WORKERS-AD3-RULE" = {
                  description  = "Allows outbound TCP egress to OKE control plane."
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-API-NSG"
                ...
                "EGRESS-TO-ANYWHERE-ICMP-WORKERS-AD3-RULE" = {
                  description = "Allows outbound ICMP for path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  dst         = "0.0.0.0/0"
                ...
                "EGRESS-TO-ANYWHERE-TCP-WORKERS-AD3-RULE" = {
                  description = "(optional) Allows worker nodes to communicate with the Internet."
                  stateless   = false
                  protocol    = "TCP"
                  dst         = "0.0.0.0/0"
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" ? {
                "EGRESS-TO-PODS-WORKERS-AD3-RULE" = {
                  description = "Allow worker nodes to access pods."
                  stateless   = false
                  protocol    = "ALL"
                  dst         = "OKE-VCN-1-PODS-NSG"
            ...
            ingress_rules = merge({
              ...
              upper(var.oke_vcn1_cni_type) == "FLANNEL" ? {
                ...
                "INGRESS-FROM-ANYWHERE-ICMP-WORKERS-AD3-RULE" = {
                  description = "Allow ICMP ingress to workers for path discovery."
                  stateless   = false
                  protocol    = "ICMP"
                  src         = "0.0.0.0/0"
                ...
                "INGRESS-FROM-BASTION-WORKERS-AD3-RULE" = {
                  description  = "Bastion service ssh access to workers"
                  stateless    = false
                  protocol     = "TCP"
                  src          = coalesce(var.oke_vcn1_mgmt_subnet_cidr, cidrsubnet(var.oke_vcn1_cidrs[0], 12, 48))
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" && var.add_oke_vcn1_mgmt_subnet ? {
                "INGRESS-FROM-OPERATOR-WORKERS-AD3-RULE" = {
                  description  = "Operator ssh access to workers"
                  stateless    = false
                  protocol     = "TCP"
                  src          = "OKE-VCN-1-MGMT-NSG"
          ...
          "OKE-VCN-1-SERVICES-NSG" = {
            ...
            egress_rules = merge({
              "EGRESS-TO-WORKERS-AD1-NSG-RULE" = {
              ...
              "EGRESS-TO-WORKERS-AD2-NSG-RULE" = {
                description  = "Allows outbound TCP to workers nodes for NodePort traffic."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              "EGRESS-TO-WORKERS-AD3-NSG-RULE" = {
                description  = "Allows outbound TCP to workers nodes for NodePort traffic."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-WORKERS-AD3-NSG"
              ...
              "EGRESS-TO-WORKERS-AD1-TCP-RULE" = {
              ...
              "EGRESS-TO-WORKERS-AD2-TCP-RULE" = {
                description  = "Allows outbound TCP egress to worker nodes for health checks."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              "EGRESS-TO-WORKERS-AD3-TCP-RULE" = {
                description  = "Allows outbound TCP egress to worker nodes for health checks."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-WORKERS-AD3-NSG"
              ...
              "EGRESS-TO-WORKERS-AD1-ICMP-RULE" = {
              ...
              "EGRESS-TO-WORKERS-AD2-ICMP-RULE" = {
                description = "Allow outbound ICMP to worker nodes for path discovery."
                stateless   = false
                protocol    = "ICMP"
                dst         = "OKE-VCN-1-WORKERS-AD2-NSG"
              ...
              "EGRESS-TO-WORKERS-AD3-ICMP-RULE" = {
                description = "Allow outbound ICMP to worker nodes for path discovery."
                stateless   = false
                protocol    = "ICMP"
                dst         = "OKE-VCN-1-WORKERS-AD3-NSG"
